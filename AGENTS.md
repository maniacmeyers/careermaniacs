...
## Maniacs brand and voice
For Career Maniacs website copy and future Maniacs brand assets, use Jeff’s voice profile at `/Users/guapo/.claude/skills/jeff-voice-profile/SKILL.md`. It governs voice, not factual claims: never invent testimonials, credentials, prices or results. Preserve quoted client words. For the requested full redesign, apply Impeccable and the installed Taste skills; record the finished reusable system in DESIGN.md.
